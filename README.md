PDFMind is a lightweight Python library that extracts text from PDF files, splits it into semantic chunks, and generates vector embeddings for offline retrieval and semantic search.
